...
class ProductsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        Product::create([
            'name' => 'キウイ',
            'price' => '800',
            'image' => 'src/storage/app/fruits-img/kiwi.png',
        ...
        Product::create([
            'name' => 'ストロベリー',
            'price' => '1200',
            'image' => 'src/storage/app/fruits-img/strawberry.png',
        ...
        Product::create([
            'name' => 'オレンジ',
            'price' => '850',
            'image' => 'src/storage/app/fruits-img/orange.png',
        ...
        Product::create([
            'name' => 'スイカ',
            'price' => '700',
            'image' => 'src/storage/app/fruits-img/watermelon.png',
        ...
        Product::create([
            'name' => 'ピーチ',
            'price' => '1000',
            'image' => 'src/storage/app/fruits-img/peach.png',
        ...
        Product::create([
            'name' => 'シャインマスカット',
            'price' => '1400',
            'image' => 'src/storage/app/fruits-img/muscat.png',
        ...
        Product::create([
            'name' => 'パイナップル',
            'price' => '800',
            'image' => 'src/storage/app/fruits-img/pineapple.png',
        ...
        Product::create([
            'name' => 'ブドウ',
            'price' => '1100',
            'image' => 'src/storage/app/fruits-img/grapes.png',
        ...
        Product::create([
            'name' => 'バナナ',
            'price' => '600',
            'image' => 'src/storage/app/fruits-img/banana.png',
